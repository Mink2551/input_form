...
function SignupPC() {
  ...
  return (
    <div>
      {inputSections === 1 ? (
        <form onSubmit={handleSubmitForm1} className="flex flex-col gap-7 my-10">
          <input
            value={StudentID}
        ...
        <form onSubmit={handleSubmitForm2} className="flex flex-col gap-7 my-10">
          <input
            value={phoneNo}
        ...
        <form onSubmit={handleSubmitForm3} className="flex flex-col gap-7 my-10">
          <input
            value={discord}
          ...
          />
          <label className="text-gray-500 font-medium">Enter Your BirthDate
            <input
              value={birthDate}
              onChange={(e) => setBirthDate(e.target.value)}
              type="date"
              className="bg-gray-100 mt-2 text-gray-400 border-gray-300 font-medium border-b-2 w-[100%] pr-4 flex mx-auto"
      ...
      {error && (
        <p className="text-red-500 rounded-b-xl font-medium text-center">{error}</p>
      )}
      {success && (
        <p className="text-green-500 rounded-b-xl font-medium text-center">{success}</p>
      )}
    </div>
  );
}
